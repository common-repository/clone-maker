...
now in right part you see the plugin with title `Clone from Page/Post` where is displayed list of available pages/posts to get content from it.

Press on icon near link to get the content from selected page/post, editor is fit with loaded content from selected page/post.
